...
def pre_person_detection_setup():
...
def person_detection(image:np.ndarray):
    """predict the classification and the location of the person
    """
    # create dataloader
    img_transform = DEFAULT_TRANSFORMS
